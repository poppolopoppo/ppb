...
func (x Color3b) Unquantize() Color3f {
	return Color3f{
...
func (x Color3f) Quantize() Color3b {
	return Color3b{
		R: quantizeColor(x.R),
		G: quantizeColor(x.G),
		B: quantizeColor(x.B),
...
func (x Color3b) Ansi(fg bool) string {
	...
	return fmt.Sprintf(ansiFmt.String(), int(x.R), int(x.G), int(x.B))
}
...
func (x Color3f) LinearToSrgb() Color3f {
	return Color3f{
		R: math.Pow(x.R, 1/2.2),
		G: math.Pow(x.G, 1/2.2),
		B: math.Pow(x.B, 1/2.2),
	}
}
