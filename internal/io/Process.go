...
func (x FileAccessType) HasRead() bool {
	return (byte)(x)&byte(FILEACCESS_READ) == byte(FILEACCESS_READ)
}
func (x FileAccessType) HasWrite() bool {
	return (byte)(x)&byte(FILEACCESS_WRITE) == byte(FILEACCESS_WRITE)
}
func (x FileAccessType) HasExecute() bool {
	return (byte)(x)&byte(FILEACCESS_EXECUTE) == byte(FILEACCESS_EXECUTE)
}
