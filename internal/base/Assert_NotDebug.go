...
func AssertErr(func() error) {}

func Assert(func() bool)                         {}
...
func LogDebug(*LogCategory, string, ...interface{})         {}
func LogDebugIf(*LogCategory, bool, string, ...interface{}) {}
func LogTrace(*LogCategory, string, ...interface{})         {}
